...
class CreateAcademiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('academies', function (Blueprint $table) {
            //
            $table->increments('id');
            $table->string('unique_id', 50)->unique()->nullable(false)->comment('学院编号');
            $table->string('name', 100)->nullable(false)->comment('学院名称');
            $table->string('description', 128) ->nullable()->comment('学院简介');
